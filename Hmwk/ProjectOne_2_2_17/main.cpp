...
void handleNotContained(bool, string&, char,
        int&, bool&, char []);
...
int main(int argc, char** argv) {
    ...
    while (running)
    {
        ...
        handleNotContained(contains, gallows, guess, incorrect,
                running, invalids);
...
void handleNotContained(bool contains, string& gallows, char guess,
