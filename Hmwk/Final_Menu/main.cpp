...
void SumTable(short [][5], short, short, int&, int&, short, short, short [],
        bool);
void printTable(short [][5], short, short, bool);
...
void start()
{
    ...
    printTable(data, rows, cols, false);
    cout << endl;
    // display the summed table
    printTable(data, rows, cols, true);
}
...
void printTable(short data[][5], short rows, short cols, bool totals)
{
    ...
    for (int y = 0; y < cols; y++)
    {
        ...
        for (int x = 0; x < rows; x++)
        {  
            SumTable(data, rows, cols, rowsTotal, colsTotal, x, y, sums,
                    totals);
        }
        cout << endl;
    }
